    ...
    <div className="flex flex-col gap-1">
      ...
      <div ref={ref} className="relative">
        <button
          type="button"
          onClick={() => setOpen((o) => !o)}
          className={`flex w-full cursor-pointer items-center gap-2 h-11 rounded-full border bg-surface-2 px-4 text-sm text-app-text outline-none transition focus:border-amber ${
