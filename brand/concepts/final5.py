...
OUT = pathlib.Path(__file__).parent / "final5"
...
def path_points(r0, r1, turns, end_deg, straighten, steps=320, ease=2.0, direction=-1):
    """Спираль, у которой хвост разгибается в прямую: приращение угла гаснет."""
    th1 = math.radians(end_deg)
    th0 = th1 - direction * turns * 2 * math.pi
    pts, th, r = [], th0, r0
    dth = (th1 - th0) / steps
    dr = (r1 - r0) / steps
